...
def times_to_win(my_ticket, winning_numbers):
	generate_winning_numbers(lottery_numbers)
	counter = 1
	if not did_win(my_ticket, winning_numbers):
		winning_numbers = []
		counter += 1
		generate_winning_numbers(lottery_numbers)
	else:
...
select_ticket_numbers()
#User's ticket is displayed
print(f"My Numbers:\n{my_ticket}")
times_to_win(my_ticket, winning_numbers)
